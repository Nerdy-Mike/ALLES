...
class Header extends Component {
  ...
  handleAddToCartToggle() {
    ...
    //? Change to other number to change animation speed
  }
    ...
    return (
      <header className="position-fixed top-0 left-0 right-0 font-weight-semibold no-print">
        ...
        >
          <div className='ml-4'>
            <Link href="/">
              <a className=' mr-1 font-color-black font-size-heading'>
                ALLES
              </a>
            </Link>
          </div>
          <div className="d-flex mr-4">
            ...
            <div className="d-none d-sm-flex">
              <Link href="/collection">
                <a className=" font-color-black font-size-subheader link mr-4">Shop</a>
              </Link>
              <Link href="/about">
                <a className="font-color-black font-size-subheader link mr-4">Về chúng tôi</a>
              </Link>
              <Link href="/contact">
                <a className="font-color-black font-size-subheader link mr-4">Liên hệ</a>
              </Link>
            </div>
            <div
              className="position-relative cursor-pointer link"
              onClick={this.toggleCart}
            >
              <Animation isStopped={ this.state.playAddToCartAnimation } />
              <div className="cart-count position-absolute font-size-tiny font-weight-bold link">
                {cart.total_items}
              </div>
            </div>
          </div>
